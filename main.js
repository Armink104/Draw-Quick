...
"cooler","couch","cow","crab","crayon","crocodile","crown","cruise ship","cup",
...
"kangaroo","key","keyboard","knee","knife","ladder","lantern","laptop","leaf",
"leg","light bulb","lighter","lighthouse","lightning","line","lion","lipstick",
"lobster","lollipop","mailbox","map","marker","matches","megaphone","mermaid",
"microphone","microwave","monkey","moon","mosquito","motorbike","mountain","mouse",
"moustache","mouth","mug","mushroom","nail","necklace","nose","ocean","octagon",
"octopus","onion","oven","owl","paintbrush","paint can","palm tree","panda",
"pants","paper clip","parachute","parrot","passport","peanut","pear","peas",
...
"swingset","sword","syringe","table","teapot","teddy-bear","telephone",
...
"trumpet","tshirt","umbrella","underwear","van","vase","violin","washing machine",
...
document.getElementById("sketch_to_drawn").innerHTML="Sketch To Be Drawn:";
